<div align="center">
	<img alt="الصورة الرئيسية" src="images/ar.png" />
</div>
...
هذه أداة إسلامية بسيطة خاصة بنظام ويندوز والتي تعرض وقت الصلاة القادمة إلى جانب العد العكسي على شريط المهام وهذا لمساعدة المستخدم على تتبع أوقات الصلوات.
...
حاليا الأداة تدعم خمس خدمات للحصول على أوقات الصلوات إعتمادا على إعدادات المستخدم:
...
> [!note]
> تغييرات جد مهمة تم برمجتها بخصوص التحديث الكبير القادم (v5). يمكن الاطلاع على التفاصيل في المناقشة #59.

> [!caution]
> الغاية الأساسية من هذه الأداة هو الحصول على فكرة حول ما إذا كانت الصلاة القادمة قريبة أم لا بطريقة بسيطة دون الحاجة إلى الضغط أو فتح أي شيء.
...
> [!note]
> إذا ظهر لك خطأ حول عدم وجود Windows App Runtime بعد تثبيته، فقم بالذهاب إلى صفحة التحميل وقم بتحميل *Redistributable* بدلا من *Installer*، ثم افتح الأرشيف وقم بتثبيت الحزمة `MSIX\win10-x64 (or x86, or arm64)\Microsoft.WindowsAppRuntime.DDLM.1.5.msix`
...
> [!warning]
> إذا قمت باختيار برنامج التثبيت نسخة `x86` بينما لديك نظام التشغيل بهندسة `x64` فإن الأداة قد لا يتم تثبيتها بشكل صحيح.
...
- أذان الفجر بصوت الشيخ ناصر القطامي هو نسخة مصححة للتسجيل الأصلي عند **إذاعة القرآن الكريم من الشارقة**. جميع الحقوق محفوظة لـ[إذاعة القرآن الكريم من الشارقة](https://www.youtube.com/channel/UCn8lMRYDANs_1yAL3iuw7_g).
